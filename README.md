...
- Nous déclarons sur l’honneur que le code fourni a été produit par nous-mêmes, à l’exception des lignes ci dessous :
    ...
    - Dans charts.py :
        ...
        Nous avions rencontré des bugs et pour le corrigé nous avons eu recours à l'IA
    ...
    - Dans nba_map.py :
        ...
        Nous nous sommes appuyé sur les informations trouvées sur le site plotly : https://plotly.com/python-api-reference/generated/plotly.graph_objects.Scattermapbox.html
    
    - Dans stats_service.py :
        ```python
    ...
    - Dans map_view.py :
        ...
        En majorité nous nous sommes basé sur les outils de compréhension présent sur le site suivant : https://wiki.openstreetmap.org/wiki/Mercator
